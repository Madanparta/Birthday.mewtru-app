            ...
            <div className='w-[80%] h-fit bg-white mt-20 px-4 py-3 shadow-lg relative'>
              <div className='w-full h-fit px-3'>
                ...
                <div className='w-full flex gap-3 bg-gray-50 px-1 py-1 items-center h-7'>
                  ...
                  <CopyToClipboard text={`https://beeta-birthday-mewtru.netlify.app/${dataTran?.data?.id}-${dataTran?.data?.customeEnd}`} onCopy={onCopy}>
                    <p className='w-full h-full flex items-center cursor-copy overflow-hidden'>{`https://beeta-birthday-mewtru.netlify.app/${dataTran?.data?.id}-${dataTran?.data?.customeEnd}`}</p>
                  </CopyToClipboard>
